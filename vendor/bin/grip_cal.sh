...
#    echo 0x3b 0 > /sys/class/grip_sensor/snt8100fsr/set_reg
    ...
    sleep 1
    echo 128 0x00 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
    sleep 1        
...
if [ "$GRIP_CAL" == "6" ]; then
    setprop persist.grip.calibration_done 0
    echo 1 > /sys/class/grip_sensor/snt8100fsr/wake_device
    echo 107 0x00 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
    ...
    echo 110 0x00 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
    sleep 1
    echo 128 0x01 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
    sleep 1
    setprop persist.grip.calibration_done 1
fi
if [ "$GRIP_CAL" == "7" ]; then
...
if [ "$GRIP_CAL" == "1012" ]; then
    ...
    echo 110 0x04 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
...
if [ "$GRIP_CAL" == "1018" ]; then
	...
	echo 0x2c 0x0000 0 0x0803 > /sys/class/grip_sensor/snt8100fsr/set_reg
    echo 110 0x05 > /sys/class/grip_sensor/snt8100fsr/set_sys_param
...
if [ "$GRIP_CAL" == "1028" ]; then
    setprop persist.grip.calibration_done 0
    if [ -f /sys/class/grip_sensor/snt8100fsr/set_reg ]; then
        echo 0x10 0 > /sys/class/grip_sensor/snt8100fsr/set_reg
        echo 0x20 0x0404 > /sys/class/grip_sensor/snt8100fsr/set_reg
    fi
    if [ -f /sys/class/grip_sensor/aw8680x/hapticTrigger ]; then
        echo 1 > /sys/class/grip_sensor/aw8680x/hapticTrigger
    fi
    setprop persist.grip.calibration_done 1
fi
...
if [ "$GRIP_CAL" == "1029" ]; then
    ...
    if [ -f /sys/class/grip_sensor/aw8680x/hapticTrigger ]; then
        echo 2 > /sys/class/grip_sensor/aw8680x/hapticTrigger
    fi
    setprop persist.grip.calibration_done 1
fi
